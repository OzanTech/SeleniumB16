...
public class Practice {
    ...
    public void practice1() throws InterruptedException {
        ...
        softAssert.assertEquals(BrowserUtils.getText(messageAlertBox),"You selected");
        ...
        alert.dismiss();
        softAssert.assertEquals(BrowserUtils.getText(messageAlertBox),"Press a buttonfd!");
        //System.out.println(BrowserUtils.getText(messageAlertBox));

 ...
 */
        ...
        WebElement cat3Header=driver.findElement(By.xpath("//div[@class='page-title-head hgroup']"));
        Assert.assertEquals(BrowserUtils.getText(cat3Header),"Category Archives: SoftwareTesting");
